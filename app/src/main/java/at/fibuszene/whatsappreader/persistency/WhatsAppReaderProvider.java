...
public class WhatsAppReaderProvider extends ContentProvider {
    private static final String TAG = WhatsAppReaderProvider.class.getSimpleName();
    ...
    public static final String AUTHORITY = "at.fibuszene.whatsappreader.provider";
